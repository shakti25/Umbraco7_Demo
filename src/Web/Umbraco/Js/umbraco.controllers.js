...
*/
    ...
    angular.module('umbraco').controller('Umbraco.PropertyEditors.RTEController', function ($scope, $q, $locale, assetsService, $timeout, tinyMceService, angularHelper, stylesheetResource, macroService, entityResource) {
